...
DISTPREFIX     := liberation-mono-dz-$(VER)
DISTPREFIX_TTF := liberation-mono-dz-ttf-$(VER)
...
ttf-dir:: $(SFDFILES)
	...
	$(PYTHON) $(FONTTOOLSCRIPT) src/$(NAME)*.ttf
	mv  src/LiberationMonoDz-Regular-fixed.ttf  src/LiberationMonoDz-Regular.ttf
	mv  src/LiberationMonoDz-Italic-fixed.ttf  src/LiberationMonoDz-Italic.ttf
	mv  src/LiberationMonoDz-Bold-fixed.ttf  src/LiberationMonoDz-Bold.ttf
	mv  src/LiberationMonoDz-BoldItalic-fixed.ttf  src/LiberationMonoDz-BoldItalic.ttf
...
dist-ttf: ttf
	$(PYTHON) $(FONTTOOLSCRIPT) export/$(NAME)*.ttf
	mv  export/LiberationMonoDz-Regular-fixed.ttf  export/LiberationMonoDz-Regular.ttf
	mv  export/LiberationMonoDz-Italic-fixed.ttf  export/LiberationMonoDz-Italic.ttf
	mv  export/LiberationMonoDz-Bold-fixed.ttf  export/LiberationMonoDz-Bold.ttf
	mv  export/LiberationMonoDz-BoldItalic-fixed.ttf  export/LiberationMonoDz-BoldItalic.ttf
	tempdir=$$(mktemp -d) \
